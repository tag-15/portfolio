  ...
  const experiences = [
    {
      ...
      image: exp,
      description:
        "Experienced as a Systems Analyst focusing on system optimization, web development, and database management. Leading cross-functional teams and implementing innovative solutions.",
      technologies: ["Angular", "SQL Server", "Git", "Agile"],
      achievements: [
